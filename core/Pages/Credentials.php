...
class Credentials extends WPPage
{
    ...
    public function postRequestPermission($request)
    {
        $is_valid_request = parent::postRequestPermission($request);

        if (is_wp_error($is_valid_request)) return $is_valid_request;
